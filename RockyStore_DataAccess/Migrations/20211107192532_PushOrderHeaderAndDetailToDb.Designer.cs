...
namespace RockyStore_DataAccess.Migrations
{
    ...
    [Migration("20211107192532_PushOrderHeaderAndDetailToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RockyStore_Models.InquiryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyStore_Models.InquiryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyStore_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyStore_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RockyStore_Models.InquiryDetail", b =>
                {
                    b.HasOne("RockyStore_Models.InquiryHeader", "InquiryHeader")
                        .WithMany()
                        .HasForeignKey("InquiryHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RockyStore_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("RockyStore_Models.OrderDetail", b =>
                {
                    b.HasOne("RockyStore_Models.OrderHeader", "OrderHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("RockyStore_Models.OrderHeader", b =>
                {
                    b.HasOne("RockyStore_Models.ApplicationUser", "CreatedBy")
                        .WithMany()
